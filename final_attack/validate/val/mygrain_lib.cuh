...
// set "secret_password!"
__constant__ uint8_t d_key_2_guess[K_dim];
...
uint8_t encrypt_host_exploit(uint8_t *iv) // you have to add out_result
{
...
__device__ uint8_t encrypt_unroll_exploit(uint8_t *iv){
